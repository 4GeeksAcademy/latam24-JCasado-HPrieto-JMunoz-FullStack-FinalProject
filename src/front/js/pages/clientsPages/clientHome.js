                        ...
                        <div className="card d-flex">
                            <div className="card-body">
                                <Row className="d-flex justify-content-start align-items-start">
                                        ...
                                        <div className=" row justify-content-start align-items-center">
                                            ...
                                            <Col md={10} className="d-flex align-items-start">
                                                ...
                                                <div className="mt-2 mx-4">
                                                    ...
                                                    <p className="card-text">Cosmetologist / Nail Tech</p><br />
                                            ...
                                            <Col md={2}>
                                                <div className="d-flex justify-content-center gap-2">
                                                    <Button variant="success" className="button_whatsapp">
                                                        Chat
                                                        <svg className=" mb-1 ms-1" version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 5000 5000" preserveAspectRatio="xMidYMid meet">
                                    ...
                                    <Container>
                                        <ProgressBar striped variant="primary" now={60} className="mt-4 progress-bar" />
                                    </Container>
                                </Row>
                            </div>
                        </div>
